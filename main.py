...
reversed.export('out/reversed.wav', format='wav')

# get clip of audiofile
# slicing in milliseconds! how cool is that?
first_2_minutes = original[0:2000]
first_2_minutes.export('out/first_2_minutes.wav', format='wav')
...
merged.export('out/merged.wav', format='wav')
print(f'{len(merged)=} ms')

# create 1000 ms of silence
silence = AudioSegment.silent(1000)
silence.export('out/silence.wav', format='wav')
print(f'{len(silence)=} ms')

# repeat clip n times
double_original = original * 2
double_original.export('out/double_original.wav', format='wav')
...
doubleoriginalincreased_silence_reversed.export('out/doubleoriginalincreased-silence-reversed.wav', format='wav')
